...
if (resp['state']['open']) {
   jQuery('#spacestatus').html('<span style="color:#f2f2f2; background-color:#5cb85c; padding:3px 5px 3px 5px; border-radius:4px; display:inline-block;">Das Eigenbaukombinat ist <span id="howlong"></span> offen,   <a href="/anpassung-der-verhaltensregeln/" style="color:#5c5cb8">Anmelde-, Verhaltens- und Hygieneregeln beachten</a>!</span>');
